...
mixin _$QuestsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            List<Quest> quests, String searchQuery, bool showCompleted)
        loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Quest> quests, String searchQuery, bool showCompleted});
}
...
class _$LoadedImpl implements _Loaded {
  ...
  @override
  String toString() {
    return 'QuestsState.loaded(quests: $quests, searchQuery: $searchQuery, showCompleted: $showCompleted)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_quests), searchQuery, showCompleted);
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(quests, searchQuery, showCompleted);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(quests, searchQuery, showCompleted);
  }
...
abstract class _Loaded implements QuestsState {
  const factory _Loaded(
      {required final List<Quest> quests,
      final String searchQuery,
      final bool showCompleted}) = _$LoadedImpl;
